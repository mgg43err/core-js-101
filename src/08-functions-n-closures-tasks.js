...
function getPolynom(...args) {
  const f = (e) => {
    ...
    if ([...args].length === 2) {
      return [...args][0] * e + [...args][1];
    } if ([...args].length === 3) {
      return [...args][0] * e ** 2 + [...args][1] * e + [...args][2];
    }
    return true;
  };
  return f;
...
function partialUsingArguments(fn, ...firstArg) {
  return (...args) => fn.apply(null, [...firstArg, ...args]);
}

// fn.apply(null, [firstArg, ...args]);
